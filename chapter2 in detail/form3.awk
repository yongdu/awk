...
BEGIN { 
        ...
        printf("%-18s %-40s %19s\n\n", "Report No.3", "POPULATION, AREA, POPULATATION DENSITIY", date)
        printf("%-14s %-14s %-23s %-14s %-11s\n\n", "CONTINENT", "COUNTRIES", "POPULATION", "AREA", "POP. DEN.")
...
END { 
 ...
 function totalprint() { # print total for previous continent
        printf(tfmt, "-----","-----","-----","-----")
